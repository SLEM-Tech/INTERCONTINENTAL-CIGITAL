		...
		<section className='flex w-full bg-white mt-6 py-4 px-5 sm:px-8 pb-12 slg:pb-0 slg:mb-20'>
			<div className='flex flex-col w-full py-3'>
				...
				<div className='text-base md:text-lg leading-relaxed text-gray-700 max-w-4xl space-y-4'>
					<p>
						Intecontinental Cigital Service Concept Limited is a premier global
						logistics &amp; supply chain solutions provider,&nbsp; specializing
						in seamless cross&#8209;border transportation &amp; customized
