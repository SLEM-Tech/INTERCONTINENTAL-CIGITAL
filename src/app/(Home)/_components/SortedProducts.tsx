			...
			<div className='space-y-8'>
				...
				<div className='relative'>
					...
					<div className='relative w-full'>
						<div className='flex justify-start overflow-x-auto pb-2 no-scrollbar px-2 w-full'>
					...
					{filteredCategories?.length > 0 && (
						<div
							className='absolute -bottom-1 left-0 h-0.5 bg-white transition-all duration-300 shadow-sm'
							style={{
